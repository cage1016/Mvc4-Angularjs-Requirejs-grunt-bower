...
Number.prototype.padLeft = function (l, c) {
    return Array(l - this.toString().length + 1).join(c || " ") + this
};
...
d = "/^\.[a-zA-Z0-9]$/";
String.prototype.snippet = function (k, m) {
    var e, f, j, n, h, l, g;
    if (k == null) {
        k = 50
    }
    ...
    if (e > 0) {
        f = this.substr(e);
        if (d.match && d.match(f)) { //d.match(f)
            k = k - f.length
        } else {
            e = this.length;
            f = ""
...
String.prototype.em_snippet = function (f, e) {
    return new Emstring(this).snippet(f, e).toString()
};
String.prototype.reverse = function (b) {
    var g, f, e;
    e = this.split("");
    f = e.reverse();
    g = f.join("");
...
Emstring.prototype.init = function (a) {
    this.s = a;
    this.info = this.widthInfo();
    return this.length = a.length ? this.info[this.s.length - 1] : 0
}
...
Emstring.prototype.widthInfo = function () {
    ...
    b = {};
    b[-1] = 0;
    for (a = d = 0, c = this.s.length; 0 <= c ? d < c : d > c; a = 0 <= c ? ++d : --d) {
        b[a] = b[a - 1] + this.ems(this.s.charAt(a))
    }
    return b
}
Emstring.prototype.create = function (a) {
    return new Emstring(a)
}
Emstring.prototype.findSpot = function (b) {
    var d, f, a, c;
    if (!b) {
        return 0
    }
...
Emstring.prototype.ems = function (g) {
    var b, a, f, e, d;
    a = 0.65;
    b = 1.08;
    f = 0.58;
    e = g.charCodeAt(0);
    d = Emstring.CODEPOINT_TO_WIDTH[e];
    if (d) {
...
Emstring.prototype.substr = function (d, a) {
    var b, c;
    c = this.findSpot(d);
    if (a != null) {
        b = this.findSpot(d + a);
...
Emstring.prototype.indexOf = function (b) {
    var a;
    a = this.s.indexOf(b);
    if (a > -1) {
        return this.info[a - 1]
    } else {
        return -1
    }
}
Emstring.prototype.lastIndexOf = function (b) {
    var a;
    a = this.s.reverse().indexOf(b.reverse());
    if (a < 0) {
        return -1
    }
